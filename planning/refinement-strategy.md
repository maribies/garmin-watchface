...
**Verification:** Memory — done, via the isolated bisection test above (real thrown exceptions at measured thresholds, not absence-of-warning). Architecture — adding a trick (or a stub one) touches meaningfully fewer places than it does today.
